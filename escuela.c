...
int main()
{
    ...
    struct datosAlumno listaAlumnos[100] = {{.matricula = 12121, .telefono = 4343434343LL, .nombre = "yo", .carrera = "Computacion", .correo = "@.", .semestre = 7, .fechaNac = {.dd = 5, .mm = 9, .aaaa = 2002}},
    ...
    struct datosProfesor listaProfesores[100]={{.telefono=1029394939LL, .numEmpleado=11, .coordinacion=3, .nombre="Pabla", .correo="pabla@gmail.com", .fechaNac={.dd=1, .mm=3, .aaaa=1997 }},
    ...
    struct datosMateria listaMaterias[100]={{.clave=31, .semestre=1, .nombre="Fisico"},
